...
public class KeydroidxFeedbackConfig {
    ...
    /** 上传接口完整 URL，如 "https://your.server.com/upload" */
    public final String uploadUrl;
    /**
     * 安装统计上报接口完整 URL，如 "https://your.server.com/install"。
    ...
    public KeydroidxFeedbackConfig(String uploadUrl, String secretKeyHex,
     ...
     */
    public KeydroidxFeedbackConfig(String uploadUrl, String installUrl,
