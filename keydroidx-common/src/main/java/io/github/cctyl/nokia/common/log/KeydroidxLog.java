...
public class KeydroidxLog {
    ...
    public static final String DEFAULT_TAG = "KeydroidxLog";
    ...
    public static synchronized void init(@NonNull Context context, @NonNull File logDir) {
        ...
        try {
            ...
            // 启动后台写入线程
            sWriteThread = new HandlerThread("KeydroidxLogWriter");
            sWriteThread.start();
            ...
            Log.i("KeydroidxLog", "KeydroidxLog initialized: dir=" + sLogDir.getAbsolutePath()
            ...
            sLogDir = null;
            sWriteHandler = null;
            Log.w("KeydroidxLog", "KeydroidxLog init failed, file logging disabled", t);
        }
    }
    ...
    public static void setDetailedLogEnabled(@NonNull Context context, boolean enabled) {
        ...
        Log.i("KeydroidxLog", "Detailed log switch changed: " + enabled
    ...
    private static class WriteHandler extends Handler {
        ...
        private void writeLine(String line) {
            try {
                ...
                Log.e("KeydroidxLog", "Failed to write log to file", e);
                closeWriter();
            }
        }
