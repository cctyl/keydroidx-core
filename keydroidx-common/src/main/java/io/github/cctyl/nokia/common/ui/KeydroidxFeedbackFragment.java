 ...
 *
 * <p>属于 {@code keydroidx-common}，零业务依赖：主题取自全局 {@link ThemeProvider}，
 * 按键由宿主 Activity（实现 {@link io.github.cctyl.nokia.common.model.KeyResolver}）解析，
 * 文本输入复用 {@link KeydroidxTextInputFragment}（全屏编辑页），日志上传复用 {@link KeydroidxFeedback}。</p>
 *
 * <h3>两端的接入方式</h3>
 * <ul>
 *   <li>桌面 Launcher：直接 {@code pushFragment(new KeydroidxFeedbackFragment())} 压入桌面 Fragment 栈；</li>
 *   <li>独立 App（经 {@code keydroidx-key-core}）：由 {@code KeydroidxFeedbackActivity} 超薄壳托管本 Fragment。</li>
 * </ul>
 *
 * <h3>按键映射</h3>
 * <ul>
 ...
 * </ul>
 */
public class KeydroidxFeedbackFragment extends KeydroidxPageFragment {
    ...
    private KeydroidxTheme.ThemeDef theme;
    ...
    protected void onPageCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        theme = KeydroidxUi.getTheme(requireContext());
    ...
    private void refreshLogInfo() {
        File logDir = KeydroidxFeedback.resolveLogDir(requireContext());
    ...
    private void openTypeMenu() {
        KeydroidxOptionsDialog dialog = new KeydroidxOptionsDialog(requireContext(), "问题类型");
    ...
    private int getHostContainerId() {
        if (getActivity() instanceof io.github.cctyl.nokia.common.ui.KeydroidxBaseActivity) {
    ...
    private void doSubmit() {
        ...
        KeydroidxFeedbackConfig config = KeydroidxFeedback.getConfig();
        ...
        KeydroidxFeedback.submit(requireContext(), contact, comment, extra, true,
