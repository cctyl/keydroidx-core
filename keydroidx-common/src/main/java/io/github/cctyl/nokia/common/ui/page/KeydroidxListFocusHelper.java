 ...
 * </ul>
 */
public class KeydroidxListFocusHelper {
    ...
    public KeydroidxListFocusHelper() {
    }

    public KeydroidxListFocusHelper(@Nullable ScrollView scrollView) {
     ...
     * 绑定 ScrollView 滚动容器。
     */
    public KeydroidxListFocusHelper setScrollView(@Nullable ScrollView scrollView) {
        this.scrollView = scrollView;
        return this;
    }
     ...
     */
    public KeydroidxListFocusHelper setCyclic(boolean cyclic) {
        this.cyclic = cyclic;
        return this;
    }
    ...
    public boolean setFocusIndex(int index, boolean autoScroll) {
        ...
        if (selectedView != null) {
            ...
            if (ctx != null) {
                selectedView.setBackground(KeydroidxTheme.createSelectionDrawable(ctx, 4));
            }
     ...
     * 处理方向键导航事件。
     *
     * @param direction 为 {@link KeydroidxKeyAction#UP}、{@link KeydroidxKeyAction#DOWN} 等
