 ...
 */
public abstract class KeydroidxListPageFragment extends KeydroidxPageFragment {
     ...
     * 子类可覆写实现左右切页签等逻辑。
     *
     * @param direction {@link KeydroidxKeyAction#LEFT} 或 {@link KeydroidxKeyAction#RIGHT}
    ...
    protected void applyFocusBackground() {
        if (focusIndex >= 0 && itemViews != null && focusIndex < itemViews.length) {
            ...
            if (view != null && getContext() != null) {
                view.setBackground(KeydroidxTheme.createSelectionDrawable(getContext(), 4));
                selectedView = view;
                view.requestFocus();
            }
        }
