 ...
 *         .setFallbackUrl(KeydroidxUpdateConfig.DEFAULT_FALLBACK_URL);
 * }</pre>
 */
public final class KeydroidxUpdateConfig {
    ...
    public KeydroidxUpdateConfig(String repoUrl) {
    ...
    public KeydroidxUpdateConfig setFallbackUrl(String fallbackUrl) {
        this.fallbackUrl = fallbackUrl;
        return this;
    }

    public KeydroidxUpdateConfig setCurrentVersion(String currentVersion) {
        this.currentVersion = currentVersion;
        return this;
    }

    public KeydroidxUpdateConfig setIncludePreRelease(boolean includePreRelease) {
        this.includePreRelease = includePreRelease;
        return this;
    }

    public KeydroidxUpdateConfig setApkAssetKeyword(String apkAssetKeyword) {
        this.apkAssetKeyword = apkAssetKeyword;
        return this;
    }

    public KeydroidxUpdateConfig setTimeoutMs(int timeoutMs) {
