...
public class KeydroidxUpdateInfo {
    ...
    public KeydroidxUpdateInfo(String version, String tagName, String releaseName, String htmlUrl,
    ...
    public boolean isNewerThan(String currentVersion) {
        return KeydroidxUpdateChecker.compareVersion(version, currentVersion) > 0;
    }
    ...
    public String toString() {
        return "KeydroidxUpdateInfo{version=" + version + ", tag=" + tagName
