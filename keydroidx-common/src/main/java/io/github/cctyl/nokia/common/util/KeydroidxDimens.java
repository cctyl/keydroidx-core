...
public final class KeydroidxDimens {
    ...
    /**
     * 全局用户字体缩放倍率。
     * @deprecated 请使用 {@link io.github.cctyl.nokia.common.ui.KeydroidxFontManager#getFontScale()} 与
     * {@link io.github.cctyl.nokia.common.ui.KeydroidxFontManager#setFontScale(float)}。
     * 生态文字缩放统一由 KeydroidxFontManager 单一源管理。
     */
    @Deprecated
    public static volatile float sUserFontScale = 1.0f;

    private KeydroidxDimens() {
        // utility class
    }
