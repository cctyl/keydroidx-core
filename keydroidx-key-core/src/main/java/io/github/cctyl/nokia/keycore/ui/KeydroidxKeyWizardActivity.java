 ...
 */
public class KeydroidxKeyWizardActivity extends AppCompatActivity {

    public static void start(Context context) {
        Intent intent = new Intent(context, KeydroidxKeyWizardActivity.class);
    ...
    private static final int[] STEPS = {
            KeydroidxKeyAction.ACTION_UP,
            KeydroidxKeyAction.ACTION_DOWN,
            KeydroidxKeyAction.ACTION_LEFT,
            KeydroidxKeyAction.ACTION_RIGHT,
            KeydroidxKeyAction.ACTION_SELECT,
            KeydroidxKeyAction.ACTION_SOFT_LEFT,
            KeydroidxKeyAction.ACTION_SOFT_RIGHT,
            KeydroidxKeyAction.ACTION_LOCK_SCREEN,
            KeydroidxKeyAction.ACTION_CALL
    };
    ...
    private KeydroidxKeyBinding draftBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        draftBinding = KeydroidxClient.get(this).getBinding().clone();
