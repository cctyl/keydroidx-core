...
public class NokiaTheme {
    ...
    public static ThemeDef getTheme(String themeId) {
        ...
        switch (themeId) {
            case THEME_EMERALD_GREEN:
                return new ThemeDef(
                        THEME_EMERALD_GREEN, "祖母绿",
                        0xFF1A5E20, 0xFF0D3311, 0xFF81C784, 0xFF2E7D32,
                        0xFFE8F5E9, 0xFFA5D6A7, 0xCC1A3820,
                        0xFF2E7D32, 0xFF1B5E20,
                        0xFF001F0A, 0xFF003814, 0xFF001F0A
                );
            case THEME_AMBER_GOLD:
                return new ThemeDef(
                        THEME_AMBER_GOLD, "琥珀金",
                        0xFFB8860B, 0xFF5C4300, 0xFFFFD54F, 0xFFD4A017,
                        0xFFFFF8E7, 0xFFFFE082, 0xCC3D2E0A,
                        0xFFD4A017, 0xFF8B6914,
                        0xFF2A1C00, 0xFF4A3400, 0xFF2A1C00
                );
            case THEME_OBSIDIAN_BLACK:
                return new ThemeDef(
                        THEME_OBSIDIAN_BLACK, "曜石黑",
                        0xFF2A2A2A, 0xFF141414, 0xFFB0BEC5, 0xFF424242,
                        0xFFECEFF1, 0xFF90A4AE, 0xCC202020,
                        0xFF3A3A3A, 0xFF222222,
                        0xFF0D0D0D, 0xFF1A1A1A, 0xFF0D0D0D
                );
            case THEME_CYAN_SEA:
                return new ThemeDef(
                        THEME_CYAN_SEA, "青碧海",
                        0xFF006064, 0xFF003032, 0xFF4DD0E1, 0xFF00838F,
                        0xFFE0F7FA, 0xFF80DEEA, 0xCC00383B,
                        0xFF00838F, 0xFF004D40,
                        0xFF001A1C, 0xFF003236, 0xFF001A1C
                );
            case THEME_WINE_PURPLE:
                return new ThemeDef(
                        THEME_WINE_PURPLE, "酒红紫",
                        0xFF4A148C, 0xFF250A46, 0xFFBA68C8, 0xFF6A1B9A,
                        0xFFF3E5F5, 0xFFCE93D8, 0xCC300D59,
                        0xFF6A1B9A, 0xFF38006B,
                        0xFF150028, 0xFF280048, 0xFF150028
                );
            case THEME_CLASSIC_BLUE:
            default:
                return new ThemeDef(
                        THEME_CLASSIC_BLUE, "经典蓝",
                        0xFF1A3A6B, 0xFF0D1E38, 0xFF64B5F6, 0xFF1E88E5,
                        0xFFE8EEF5, 0xFF90CAF9, 0xCC1A2C42,
                        0xFF1E88E5, 0xFF1565C0,
                        0xFF001428, 0xFF002850, 0xFF001428
                );
        }
    }
    ...
    public static GradientDrawable createSelectedRowDrawable(ThemeDef theme) {
        GradientDrawable gd = new GradientDrawable(
                GradientDrawable.Orientation.TOP_BOTTOM,
                new int[]{theme.focusColor, theme.primaryColor}
        );
        gd.setShape(GradientDrawable.RECTANGLE);
        return gd;
    }
    ...
    public static GradientDrawable createDialogBodyDrawable(ThemeDef theme) {
        GradientDrawable gd = new GradientDrawable(
                GradientDrawable.Orientation.TOP_BOTTOM,
                new int[]{theme.bgCenterColor, theme.bgStartColor}
        );
        gd.setShape(GradientDrawable.RECTANGLE);
        return gd;
    }
